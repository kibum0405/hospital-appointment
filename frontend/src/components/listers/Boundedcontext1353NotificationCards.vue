    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <Boundedcontext1353Notification :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <Boundedcontext1353Notification :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import Boundedcontext1353Notification from './../Boundedcontext1353Notification.vue';

    export default {
        name: 'Boundedcontext1353NotificationManager',
        components: {
            Boundedcontext1353Notification,
        },
        props: {
            offline: Boolean
        },
