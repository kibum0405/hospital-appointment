        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="medicalInformations"
                        to="/managements/medicalInformations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '예약', 
                description: 'Appointment을 관리하는 화면입니다.', 
                key: 'appointments', 
            ...
            { 
                title: '진료정보', 
                description: 'MedicalInformation을 관리하는 화면입니다.', 
                key: 'medicalInformations', 
                route: '/managements/medicalInformations',
                ImageUrl: '',
            },
            { 
                title: '청구서', 
                description: 'Bill을 관리하는 화면입니다.', 
                key: 'bills', 
